...
def task1():
    script_path = 'C:\\Users\\marci\\OneDrive\\Desktop\\FIAP\\dev\\kafka\\home_debian\\01_vendas_producer.py'
    subprocess.run(['python3', script_path])

def task2():
    script_path = 'C:\\Users\\marci\\OneDrive\\Desktop\\FIAP\\dev\\kafka\\home_debian\\02_consumidor_MySQL.py'
    subprocess.run(['python3', script_path])
